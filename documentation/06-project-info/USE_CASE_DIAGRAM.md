...
| UC_A_Export | Export Data ke Excel | Admin mengexport data mahasiswa ke file Excel (.xlsx) dengan 16 kolom | Sudah login | File Excel terdownload dengan format rapi |
| UC_A_Delete | Menghapus Data Mahasiswa | Admin menghapus semua data mahasiswa secara permanen (cascade 4 tabel) | Sudah login | Data terhapus, cache di-invalidate, dashboard refresh |
...
| **Pengelolaan Hasil Tes** | 0 | 9 | 6 | 15 |
| **TOTAL** | **8** | **11** | **21** | **40** |
...
### 4.3 Use Case Admin (Administrator) - Total: 11
...
10. UC_A_Export - Export Data ke Excel
11. UC_A_Delete - Menghapus Data Mahasiswa

---

### 4.4 Use Case Sistem (Internal) - Total: 21
...
22. UC_S_Cascade - Cascade Delete (4 tabel)
23. UC_S_InvalCache - Invalidate Cache
...
| Menghapus Data Mahasiswa | include | Cascade Delete (4 tabel) |
