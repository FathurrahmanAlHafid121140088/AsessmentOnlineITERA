                      ...
                      <ul class="timeline">
                          <li data-aos="fade-right" data-aos-delay="200">
                              ...
                              <div class="timeline-panel">
                                  ...
                                  <div class="timeline-body"><p class="text-muted">Buat akun atau masuk ke sistem dengan username dan password.
                          ...
                          <li data-aos="fade-left" data-aos-delay="200" class="timeline-inverted">
                              ...
                              <div class="timeline-panel">
                                  ...
                                  <div class="timeline-body"><p class="text-muted">- Tes Mental Health → Cek tingkat stres, kecemasan, dan kesejahteraan emosional.
                          ...
                          <li data-aos="fade-right" data-aos-delay="200">
                              ...
                              <div class="timeline-panel">
                                  ...
                                  <div class="timeline-body"><p class="text-muted">Jawab pertanyaan dengan jujur sesuai kondisi Anda.
                          ...
                          <li data-aos="fade-left" data-aos-delay="200" class="timeline-inverted">
                              ...
                              <div class="timeline-panel">
                                  ...
                                  <div class="timeline-body"><p class="text-muted">Hasil otomatis ditampilkan setelah tes selesai.
                          ...
                          <li data-aos="fade-right" data-aos-delay="200">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body"><p class="text-muted">Jika membutuhkan saran lebih lanjut, Anda dapat menjadwalkan konsultasi dengan psikolog profesional.</p></div>
                            </div>
                        </li>
          ...
          <div class="container">
              ...
              <div class="row text-center g-4 ">
                  <div data-aos="flip-right" data-aos-delay="300" class="col-md-6 col-12 p-4 py-4 px-4 bg-white shadow-sm rounded-4"> 
                      ...
                      <p>Cek tingkat stres, kecemasan, dan kesehatan emosional Anda dengan metode ilmiah yang terpercaya.</p>
                      <p class="text-muted">Metode RMIH-38 (RAND Mental Health Inventory-38) adalah alat evaluasi kesehatan mental yang dirancang untuk menganalisis tingkat stres, kecemasan, dan kesejahteraan emosional secara cepat dan akurat. Dengan 38 parameter berbasis penelitian ilmiah, metode ini memberikan hasil instan yang dapat digunakan sebagai dasar konsultasi dengan psikolog.</p>
          ...
          <div class="row justify-content-center g-3"> 
            ...
            <div data-aos="zoom-in" data-aos-delay="400" class="col-md-6 col-12" >
              <div class="card rounded-3"style="background-color: #f5efeff9;">
                <div class="card-body p-4">
                  <div class="d-flex justify-content-center mb-3">
                    <img src="{{ asset('img/Steve_Jobs_Headshot_2010-CROP_(cropped_2).jpg') }}" alt="..."
                      class="rounded-circle shadow-1-strong" width="80" height="80" />
                  </div>
                  <figure class="text-center mb-0">
                    <blockquote class="blockquote mb-3">
