...
<div class="formbold-main-wrapper">
    <div class="formbold-form-wrapper">
        ...
        <form action="{{ route('mental-health.store-data-diri') }}" method="POST">
            @csrf
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    <input type="text" name="nama" id="nama" class="formbold-form-input" placeholder="Masukkan nama lengkap" required />
                </div>
                <div>
                    <label for="nim" class="formbold-form-label"> NIM </label>
                    <input type="number" name="nim" id="nim" class="formbold-form-input" placeholder="Masukkan NIM" required />
                </div>
            </div>
            ...
            <div class="formbold-mb-3">
                ...
                <div>
                    <label class="formbold-radio-label">
                        <input type="radio" name="jenis_kelamin" value="L" class="formbold-input-radio" required> Laki-laki
                    </label>
                </div>
                <div>
                    <label class="formbold-radio-label">
                        <input type="radio" name="jenis_kelamin" value="P" class="formbold-input-radio" required> Perempuan
                    </label>
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    <textarea name="alamat" id="alamat" class="formbold-form-input" placeholder="Masukkan alamat" rows="3" required></textarea>
                </div>
                <div>
                    <label for="usia" class="formbold-form-label"> Usia </label>
                    <input type="number" name="usia" id="usia" class="formbold-form-input" placeholder="Masukkan usia" required min="1" max="150" />
                </div>
            </div>
            ...
            <div>
                <label class="formbold-radio-label">
                    <input type="radio" name="fakultas" value="FS" class="formbold-input-radio" required onchange="updateProdi()"> Fakultas Sains
                </label>
            </div>
            <div>
                <label class="formbold-radio-label">
                    <input type="radio" name="fakultas" value="FTIK" class="formbold-input-radio" required onchange="updateProdi()"> Fakultas Teknologi Infrastruktur dan Kewilayahan
                </label>
            </div>
            <div>
                <label class="formbold-radio-label">
                    <input type="radio" name="fakultas" value="FTI" class="formbold-input-radio" required onchange="updateProdi()"> Fakultas Teknologi Industri
                </label>
            </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="formbold-mb-3">
                        ...
                        <input type="email" name="email" id="email" class="formbold-form-input" placeholder="Masukkan email" required />
                    </div>
                </div>
            </div>
            ...
            <div class="formbold-input-flex">
                <div>
                    ...
                    <textarea name="keluhan" id="keluhan" class="formbold-form-input" rows="4" placeholder="Masukkan keluhan yang dialami saat ini" required></textarea>
                </div>
                ...
                <div class="formbold-mb-3">
                    ...
                    <div>
                        <label class="formbold-radio-label">
                            <input type="radio" name="lama_keluhan" value="1" class="formbold-input-radio" required> 1 Bulan
                        </label>
                    </div>
                    <div>
                        <label class="formbold-radio-label">
            ...
            <div class="formbold-input-flex">
                <div class="formbold-mb-3">
                    ...
                    <div>
                        <label class="formbold-radio-label">
                            <input type="radio" name="pernah_tes" value="Ya" class="formbold-input-radio" required> Ya
                        </label>
                    </div>
                    <div>
                        <label class="formbold-radio-label">
                            <input type="radio" name="pernah_tes" value="Tidak" class="formbold-input-radio"> Tidak
                        </label>
                    </div>
                </div>
                <div class="formbold-mb-3">
                    ...
                    <div>
                        <label class="formbold-radio-label">
                            <input type="radio" name="pernah_konsul" value="Ya" class="formbold-input-radio" required> Ya
                        </label>
                    </div>
                    <div>
                        <label class="formbold-radio-label">
                            <input type="radio" name="pernah_konsul" value="Tidak" class="formbold-input-radio"> Tidak
                        </label>
                    </div>
                </div>
            </div>
