                    ...
                    <div class="table">
                        ...
                        <table id="assessmentTable">
                            ...
                            <tbody>
                                @forelse($hasilKuesioners as $hasil)
                                    ...
                                    <div id="modal-riwayat-{{ $hasil->id }}" class="custom-modal">
                                        <div class="custom-modal-content">
                                            ...
                                            @php
                                                // Gabungkan data dan group berdasarkan timestamp yang dibulatkan ke menit
                                                $merged = collect();
                                                ...
                                                foreach ($hasil->dataDiri->riwayatKeluhans as $keluhan) {
                                                    $key = \Carbon\Carbon::parse($keluhan->created_at)->format(
                                                        'Y-m-d H:i',
                                                    );
                                                    $merged->push([
                                                        'group_key' => $key,
                                            ...
                                            @forelse ($grouped as $timestamp => $entries)
                                                ...
                                                <hr>
                                            @empty
                                                <p>Tidak ada data keluhan atau kuesioner.</p>
                                            @endforelse
                                        </div>
                                    </div>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center">Belum ada data hasil kuesioner.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
